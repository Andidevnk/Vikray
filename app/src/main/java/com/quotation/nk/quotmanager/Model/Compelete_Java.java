...
public class Compelete_Java {
    ...
    public  Compelete_Java(){

    }

    public Compelete_Java(String id, String l_from, String l_to, String from, String to, String modell, String modelframe, String modelengine, String date) {
        this.id = id;
        this.l_from = l_from;
        this.l_to = l_to;
        this.from = from;
