...
public class NotIntrested_Status extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_not_intrested__status);
...
// String url="https://loadcrm.com/QMS/api/ExeQuery/1?qry=select%20Reason%20from%20DealayReason";
    ...
    public void onClick(View v) {
        if (v == date) {
            ...
            DatePickerDialog dpd = new DatePickerDialog(NotIntrested_Status.this,
        ...
        if (v == time) {
            ...
            TimePickerDialog tpd = new TimePickerDialog(NotIntrested_Status.this,android.R.style.Theme_Holo_Dialog_NoActionBar, new TimePickerDialog.OnTimeSetListener() {
                int hourOfDay;
