...
import com.quotation.nk.quotmanager.Adapter.Adapter_Gate_Send_Complete;
...
public class Compelete_Send_Fragment extends Fragment {
    ...
    public Compelete_Send_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v=  inflater.inflate(R.layout.fragment_compelete__send_, container, false);
        ...
        adapter = new Adapter_Gate_Send_Complete(getActivity(),gatepass_statuses);
