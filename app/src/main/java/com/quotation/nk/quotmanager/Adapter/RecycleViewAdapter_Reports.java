...
public class RecycleViewAdapter_Reports extends RecyclerView.Adapter<RecycleViewAdapter_Reports.ViewHolder> {
    ...
    public RecycleViewAdapter_Reports(Context context, List<Reports> list) {
...
//       holder.boodate.setText(bookindate);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,Quotation_Status.class);
