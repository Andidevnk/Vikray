...
import com.quotation.nk.quotmanager.Booking_Status;
...
public class RecycleViewAdapter_Reports2 extends RecyclerView.Adapter<RecycleViewAdapter_Reports2.ViewHolder> {
    ...
    public RecycleViewAdapter_Reports2(Context context, List<Reports> list) {
...
//       holder.boodate.setText(bookindate);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,Booking_Status.class);
