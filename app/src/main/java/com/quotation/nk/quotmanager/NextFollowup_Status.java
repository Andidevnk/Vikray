...
public class NextFollowup_Status extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_followup__status);
...
// String url="https://loadcrm.com/QMS/api/ExeQuery/1?qry=select%20Reason%20from%20DealayReason";
        ...
        statusspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (war2 == 1) {
                    ...
                    reason_spineer.setVisibility(View.VISIBLE);
                    reason_spineer.setVisibility(View.VISIBLE);
                    txt_remarks_spineer.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        if (v == date) {
            ...
            DatePickerDialog dpd = new DatePickerDialog(NextFollowup_Status.this,
        ...
        if (v == time) {
            ...
            TimePickerDialog tpd = new TimePickerDialog(NextFollowup_Status.this,android.R.style.Theme_Holo_Dialog_NoActionBar, new TimePickerDialog.OnTimeSetListener() {
                int hourOfDay;
