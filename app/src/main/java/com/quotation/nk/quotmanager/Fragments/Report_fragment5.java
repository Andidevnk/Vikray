...
import com.quotation.nk.quotmanager.Adapter.RecycleViewAdapter_Reports4;
...
public class Report_fragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_report_fragment5, container, false);
        recyclerView = (RecyclerView)v.findViewById(R.id.recyclereports5);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


        reportsList = new ArrayList<Reports>();
        adapter = new RecycleViewAdapter_Reports4(getActivity(),reportsList);
        ...
        String qury="http://loadcrm.com/quotationdiwali/api/ConvertedDate/1?SalesmanID="+test1+"";
                ...
                try
                {
                    ...
                    if (jsonarray.length()>0)
                    {
                        for (int i=0;i<jsonarray.length();i++)
                        {
                            ...
                            reports.setConvertdate(obj.getString("ConvertDate"));
