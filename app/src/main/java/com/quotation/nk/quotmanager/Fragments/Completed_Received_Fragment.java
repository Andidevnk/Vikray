...
import com.quotation.nk.quotmanager.Adapter.Adapter_Gate_Recieved_complete;
...
public class Completed_Received_Fragment extends Fragment {
    ...
    Adapter_Gate_Recieved_complete adapter;
    private JSONArray reports = null;

    SwipeRefreshLayout mSwipeRefreshLayout;
    public Completed_Received_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_completed__received_, container, false);
        ...
        adapter = new Adapter_Gate_Recieved_complete(getActivity(),gatepass_statuses);
        ...
        String qury="http://loadcrm.com/quotationdiwali/api/CompletedStatus/1?SalesmanID="+test1+"";
