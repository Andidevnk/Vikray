...
import com.quotation.nk.quotmanager.NotIntrested_Status;
...
public class RecycleViewAdapter_Reports3 extends RecyclerView.Adapter<RecycleViewAdapter_Reports3.ViewHolder> {
    ...
    public RecycleViewAdapter_Reports3(Context context, List<Reports> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
     ...
     //   String bookindate = String.valueOf(reports.getBook_date());
        String bookindate = String.valueOf(reports.getNotintrested());
...
//       holder.boodate.setText(bookindate);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,NotIntrested_Status.class);
