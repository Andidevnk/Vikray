...
import com.quotation.nk.quotmanager.Adapter.RecycleViewAdapter_Reports2;
...
public class report_fragment3 extends Fragment {

    RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private DividerItemDecoration dividerItemDecoration;
    private List<Reports> reportsList;
    RecycleViewAdapter_Reports2 adapter;
    private JSONArray reports = null;

    SwipeRefreshLayout mSwipeRefreshLayout;


    public report_fragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=  inflater.inflate(R.layout.fragment_report_fragment3, container, false);
        recyclerView = (RecyclerView)v.findViewById(R.id.recyclereports3);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


    //    recyclerView = (RecyclerView)findViewById(R.id.reportsrecycler);

        reportsList = new ArrayList<Reports>();
        adapter = new RecycleViewAdapter_Reports2(getActivity(),reportsList);
    ...
    private void shuffle() {
        ...
        String qury="http://loadcrm.com/quotationdiwali/api/BookingDate/1?SalesmanID="+test1+"";
                ...
                try
                {
                    ...
                    if (jsonarray.length()>0)
                    {
                        for (int i=0;i<jsonarray.length();i++)
                        {
                            ...
                            reports.setBook_date(obj.getString("BookingDate"));
