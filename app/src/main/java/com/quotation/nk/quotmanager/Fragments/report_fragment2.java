...
import com.quotation.nk.quotmanager.Adapter.RecycleViewAdapter_Reports1;
...
public class report_fragment2 extends Fragment {
    ...
    RecycleViewAdapter_Reports1 adapter;
    private JSONArray reports = null;
    SwipeRefreshLayout mSwipeRefreshLayout;

    public report_fragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.fragment_report_fragment2, container, false);
        recyclerView = (RecyclerView)v.findViewById(R.id.recyclereports2);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


        reportsList = new ArrayList<Reports>();
        adapter = new RecycleViewAdapter_Reports1(getActivity(),reportsList);
    ...
    private void shuffle() {
        ...
        String qury="http://loadcrm.com/quotationdiwali/api/NextFollowUp/1?SalesmanID="+test1+"";
                ...
                try
                {
                    ...
                    if (jsonarray.length()>0)
                    {
                        for (int i=0;i<jsonarray.length();i++)
                        {
                            ...
                            reports.setNxt_folllow_date(obj.getString("NextFollowUpDate"));
