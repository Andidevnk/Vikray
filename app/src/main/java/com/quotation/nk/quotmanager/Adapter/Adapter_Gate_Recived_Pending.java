...
public class Adapter_Gate_Recived_Pending extends RecyclerView.Adapter<Adapter_Gate_Recived_Pending.ViewHolder> {


    private Context context;
    private List<Gatepass_Status> list;

    Adapter_Gate_Recived_Pending adapter;


    public Adapter_Gate_Recived_Pending(Context context, List<Gatepass_Status> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.card_recieved_list, parent, false);
        return new ViewHolder(v);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull Adapter_Gate_Recived_Pending.ViewHolder holder, int position) {
