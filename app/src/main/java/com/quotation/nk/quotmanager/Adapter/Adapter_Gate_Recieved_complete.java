...
public class Adapter_Gate_Recieved_complete extends RecyclerView.Adapter<Adapter_Gate_Recieved_complete.ViewHolder> {
    ...
    public Adapter_Gate_Recieved_complete(Context context, List<Gatepass_Status> list) {
