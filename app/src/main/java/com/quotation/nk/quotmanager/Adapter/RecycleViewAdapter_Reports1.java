...
import com.quotation.nk.quotmanager.NextFollowup_Status;
...
public class RecycleViewAdapter_Reports1 extends RecyclerView.Adapter<RecycleViewAdapter_Reports1.ViewHolder> {
    ...
    public RecycleViewAdapter_Reports1(Context context, List<Reports> list) {
...
//       holder.boodate.setText(bookindate);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,NextFollowup_Status.class);
