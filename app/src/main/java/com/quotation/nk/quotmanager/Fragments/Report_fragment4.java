...
import com.quotation.nk.quotmanager.Adapter.RecycleViewAdapter_Reports3;
...
public class Report_fragment4 extends Fragment {
    ...
    RecycleViewAdapter_Reports3 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.fragment_report_fragment4, container, false);
        recyclerView = (RecyclerView)v.findViewById(R.id.recyclereports4);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));



        reportsList = new ArrayList<Reports>();
        adapter = new RecycleViewAdapter_Reports3(getActivity(),reportsList);
    ...
    private void shuffle() {
        ...
        String qury="http://loadcrm.com/quotationdiwali/api/NotInterestedDate/1?SalesmanID="+test1+"";
                ...
                try
                {
                    ...
                    if (jsonarray.length()>0)
                    {
                        for (int i=0;i<jsonarray.length();i++)
                        {
                            ...
                            reports.setNotintrested(obj.getString("NotInterestedDate"));
