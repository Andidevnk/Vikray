...
import com.quotation.nk.quotmanager.Adapter.Adapter_Gate_Recived_Pending;
...
public class Pending_Received_Fragment extends Fragment {
    ...
    public Pending_Received_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.fragment_pending__received_, container, false);
        ...
        adapter = new Adapter_Gate_Recived_Pending(getActivity(),gatepass_statuses);
